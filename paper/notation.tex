...
%
% This snippet is self-contained. NOTE: it is NOT \input by main.tex --
% the same macros are defined inline in the preamble of main.tex (see the
% "Notation macros (consistent with notation.tex)" block there); this file
% is kept as the standalone reference copy. It is consistent with the
% sibling paper "Determinant Divisibility of Centered Latin Squares".
%
% -----------------------------------------------------------------------
% Macros
% -----------------------------------------------------------------------
